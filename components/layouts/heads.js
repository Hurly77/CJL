		...
		<div className='w-full px-6 space-y-10'>
			...
			<div className='justify-between'>
				<div className='grid grid-cols-3 w-52'>
					<a className='cursor-pointer' href="https://github.com/Hurly77" rel="noreferrer" target="_blank">
						<svg
							role='img'
							viewBox='0 0 24 24'
							width='25'
					...
					<a className='cursor-pointer' href="https://linkedin.com/in/cameron-leverett" rel="noreferrer" target="_blank">
						<svg
							role='img'
							viewBox='0 0 24 24'
							width='50'
					...
					<a className='cursor-pointer' href="https://camrbo.medium.com" rel="noreferrer" target="_blank">
						<svg
							role='img'
							viewBox='0 0 24 24'
							width='50'
