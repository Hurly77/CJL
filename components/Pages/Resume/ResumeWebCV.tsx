...
function ExpCard({ exp }: { exp: (typeof Experience)[0] }) {
  return (
    <Card
      ...
      className="p-2 bg-transparent cursor-pointer hover:bg-content1 hover:shadow-small group"
    >
      <div className="text-left">
        <ArrowTopRightOnSquareIcon className="absolute w-5 h-5 sm:hidden group-hover:block top-2 right-2" />
        ...
        <p className="text-sm text-foreground-600 ">{exp.description}</p>
...
export default function ResumeWebCV() {
  return (
    <div className="max-w-(--breakpoint-lg) sm:py-12 sm:px-0 px-1">
