...
export const TestAnimation: NextPageWithLayout = () => {
  return (
    <div>
      <motion.p
...
TestAnimation.getLayout = function (page: React.ReactElement) {
  return (
    <div className="app-page2xl flex-col">
...
TestAnimation.title = "Test Animation";
